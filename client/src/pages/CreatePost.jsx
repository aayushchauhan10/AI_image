...
const CreatePost = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        <h2 className="font-extrabold text-[#222328] text-[32px]">Create</h2>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-5 flex gap-5 ">
          <button
            ...
            className="text-white bg-green-700 text-[16px] rounded-lg font-medium p-2"
          >
        ...
        <div className="mt-10">
          ...
          <button
            type="submit"
            className="mt-3 text-white bg-[#6469ff] sm:w-auto rounded-lg py-2 px-4"
          >
